      ...
      return (
        <div className="navbar-nav nav-item dropdown ml-auto">
          ...
          <div className="dropdown-menu" aria-labelledby="dropdown02">
            <Link className="dropdown-item" to="/my_posts">Postingan Anda</Link>
            <Link className="dropdown-item" to="/profile">Profil Anda</Link>
            <div className="dropdown-divider" />
            <Link className="dropdown-item" to="/settings">Pengaturan</Link>
            <Link className="dropdown-item" to="/" onClick={this.props.signoutUser}>Keluar</Link>
          </div>
        </div>
      );
    } else {
      ...
      return (
        <ul className="navbar-nav">
          <li className="nav-item" key={1}>
            <Link className="btn btn-primary" to="/signup">Buat Akun</Link>
          </li>
          <li className="nav-item" key={2}>
            <Link className="btn btn-secondary ml-sm-2" to="/signin">Masuk</Link>
          </li>
        </ul>
      );
    }
    ...
    return (
      <nav className="navbar navbar-inverse bg-inverse navbar-toggleable-md fixed-top">
        <div className="container">
          ...
          <Link className="navbar-brand" to="/">Blog Networking</Link>

          <div className="collapse navbar-collapse" id="navbarsExampleContainer">
            <ul className="navbar-nav mr-auto">
              <li className="nav-item">
                <Link className="nav-link" to="/posts">Postingan</Link>
              </li>
            </ul>
            <form className="form-inline my-2 my-md-0">
              <input className="form-control mr-sm-2" type="text" placeholder="Cari Postingan" />
