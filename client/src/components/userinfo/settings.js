    ...
    return (
      <div>
        ...
        <form className="form-signin" onSubmit={handleSubmit(this.handleFormSubmit.bind(this))}>
          ...
          <hr />
          <Field name="oldPassword" component={this.renderField} type="password" label="Password Lama" />
          <Field name="newPassword" component={this.renderField} type="password" label="Password Baru" />
          <Field name="newPasswordConfirm" component={this.renderField} type="password" label="Konfirmasi Password Baru" />
          <button action="submit" className="btn btn-primary">Ganti Password</button>
        </form>
      </div>
    );
  }
...
function validate(formProps) {
  ...
  if (formProps.newPassword !== formProps.newPasswordConfirm) {
    errors.newPasswordConfirm = 'Password harus sama!';
  }
